...
def creerSurface():
    largeur = 600
    longueur = 500
    mySurface = pygame.display.set_mode((longueur, largeur))
...
def initGame(mySurface):
    ...
    while menu:
        ...
        startbutton = pygame.image.load("images.jpg")
        startbutton = pygame.transform.scale(startbutton, (60,60))
        postartbutton = (225,475)
        ...
        zonenb = pygame.Rect((350,95),(30,30))
