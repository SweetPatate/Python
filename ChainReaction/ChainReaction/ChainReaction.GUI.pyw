...
def creerSurface():
    ...
    pygame.display.set_icon(pygame.image.load('image/rouge3.jpg'))
    return mySurface
...
def initGame(mySurface):
    ...
    while menu:
        ...
        zonebuttonleft1 = pygame.Rect(posbuttonleft1, (30, 30))
        zonebuttonleft2 = pygame.Rect(posbuttonleft2, (30, 30))
        zonebuttonleft3 = pygame.Rect(posbuttonleft3, (30, 30))

        zonebuttonright1 = pygame.Rect(posbuttonright1, (30, 30))
        zonebuttonright2 = pygame.Rect(posbuttonright2, (30, 30))
        zonebuttonright3 = pygame.Rect(posbuttonright3, (30, 30))

        zoneStart = pygame.Rect(postartbutton, (136, 52))
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN:
                if event.button == 1:
                    ...
                    if verif:
                        print("Oui, vous pouvez rajouter un point sur cette case")
                        put(gameBoard, n, m, i, j, player)
                        display(gameBoard, n, m)
                        player = player + 1

                    else:
                        print('Non, la case est déjà prise')
